...
class VISMESH_API UVisMeshProceduralComponent : public UVisMeshComponentBase, public IInterface_CollisionDataProvider
{
	GENERATED_BODY()

public:
	explicit UVisMeshProceduralComponent(const FObjectInitializer& ObjectInitializer);
